...
import { ImageiationService, JobState, JobWorker, ModalService, TrainingJob } from 'ejflab-front-lib';
...
//  JobWorker,
//  TrainingJob,
//} from 'src/services/imagiation.service';
...
export class JobdetailComponent implements OnInit, OnDestroy {
  ...
  async cancelJob() {
    const responseConfirm = await this.modalSrv.confirm({
      title: `¿Abortar el procesamiento?`,
    ...
    await this.imagiationSrv.saveJob('img2mesh', this.pageId, this.job);
    this.dialogRef.close(this.job);
  }
