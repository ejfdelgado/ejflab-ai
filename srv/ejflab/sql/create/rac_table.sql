...
CREATE SEQUENCE IF NOT EXISTS ${schema | singleWord}.sequence_rac_${name | singleWord}
    INCREMENT 1
    START 1
    MINVALUE 1
...
ALTER SEQUENCE ${schema | singleWord}.sequence_rac_${name | singleWord}
    OWNER TO "user";

CREATE TABLE IF NOT EXISTS ${schema | singleWord}.rac_${name | singleWord}
(
    id integer NOT NULL DEFAULT nextval('sequence_rac_${name | singleWord}'::regclass),
